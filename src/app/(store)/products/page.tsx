...
const Product = () => {
  return (
    <StoreLayout>
      <div className="relative h-screen  overflow-hidden bg-gradient-to-r from-[#003d5b] to-[#00798c]">
        <div className="max-w-7xl mx-auto px-4 h-full flex flex-col">
          <div className="flex-grow flex flex-col md:flex-row items-center justify-center md:justify-between">
            <div className="w-1/2 text-center md:text-left mb-10 md:mb-0 z-10">
              ...
              <p className="text-xl text-white/80 max-w-lg mb-10 mt-4">
                Experience exception quality and service with our curated
                selection of premium products.
              </p>

              <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                <Link
                  className="px-8 py-3 bg-[#d1495b] text-white rounded-full hover:bg-[#di495b]/90 transition-all transform hover:scale-105 shadow-lg flex items-center justify-center"
                  href={"/product"}
                >
                  Shop Now <FaChevronRight className="ml-1 text-xl" />
                </Link>
              </div>
            </div>

            {/*  */}
            <div className="w-1/2 relative z-10 flex flex justify-center md:justify-end ">
